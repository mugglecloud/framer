...
class DesignComponent extends React.Component {
  ...
  _renderData(presentation, componentProps, topLevelProps) {
    ...
    if (topLevelProps) {
      ...
      // 'style' take presidence over the props, _initialStyle reverses that
      props = Object.assign(
        Object.assign(Object.assign({}, rest), topLevelProps),
        { _initialStyle: style }
      );
    }
    ...
    const c =
      ...
      children.map((child, childIndex) =>
        this._renderData(child, componentProps, undefined)
      );
    children = children ? c : [];
    ...
    if (this.hasParentError()) {
      return React.createElement(
        ...
        React.createElement(
          ...
          "Design Component cannot be nested in itself."
        )
      );
    }
    ...
    if (!data) {
      return React.createElement(
        ...
        React.createElement(
          "p",
          { style: errorMessageStyle },
          "Unable to connect to canvas data store."
        )
      );
    }
