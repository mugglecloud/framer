...
import { unwrapMotionValue } from "framer-motion";
...
export function collectTransformFromProps(props, rect, style) {
    ...
    const rotationZ = getRotation(props.rotationZ, unwrapMotionValue(motionStyle.rotateZ));
    const rotationX = getRotation(props.rotationX, unwrapMotionValue(motionStyle.rotateX));
    const rotationY = getRotation(props.rotationY, unwrapMotionValue(motionStyle.rotateY));
    ...
    const rotation = getRotation(props.rotation, unwrapMotionValue(motionStyle.rotate));
