...
export function Page(props) {
    ...
    return (React.createElement(FrameWithMotion, Object.assign({ preserve3d: false, perspective: hasEffect(props) ? 1200 : undefined, overflow: overflow }, containerProps, { ref: containerRef }),
        React.createElement(FrameWithMotion, { "data-framer-component-type": "Page", ref: scrollableRef, background: null, x: contentOffsetRef.current.x, y: contentOffsetRef.current.y, animate: scrollControls, width: "100%", height: "100%", preserve3d: true, style: {
