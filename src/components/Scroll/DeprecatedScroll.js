  ...
  render() {
    return React.createElement(
      ...
      ({ size: newParentSize }) => {
        ...
        draggableProps.onDragSessionEnd = this.wrapHandlers(
          this.props.onDragSessionEnd,
          onScrollSessionEnd
        );
        ...
        draggableProps.onDragDidMove = this.wrapHandlers(
          this.props.onDragDidMove,
          onScroll
        );
        draggableProps.onDragDirectionLockStart = this.props.onDragDirectionLockStart;
        draggableProps.onDragStart = this.wrapHandlers(
          this.props.onDragStart,
          onScrollStart
        );
        draggableProps.onDragEnd = this.wrapHandlers(
...
/** @internal */
DeprecatedScroll.defaultProps = Object.assign(
  {},
