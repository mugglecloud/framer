...
export function Scroll(props) {
    ...
    return (<FrameWithMotion {...containerProps} overflow={overflow} style={{ background: "transparent", ...style }} preserve3d={containerProps.preserve3d} ref={containerRef}>
            <FrameWithMotion animate={scrollAnimate} drag={dragEnabled && convertScrollDirectionToDrag(direction)} dragDirectionLock={directionLock} dragConstraints={dragConstraints} onDragStart={onMotionDragStart} onDrag={onDrag} onDragEnd={onDragEnd} onDragTransitionEnd={onMotionDragTransitionEnd} onUpdate={updateScrollListeners} onDirectionLock={onDirectionLock} width={actualContentSize.width} height={actualContentSize.height} style={{
        ...
        y,
                ...
                <div ref={dragRef} style={{ display: "contain" }}>
