...
import {
  ...
  defaultFrameRect,
  unwrapFrameProps,
} from "../../render/presentation/Frame/FrameWithMotion";
...
const useScrollConstraints = (size, dragDirection, children) => {
  return useMemo(() => {
    let contentSize;
    if (!size) return [contentSize, children];
    contentSize = {
      width: size.width,
      height: size.height,
    };
...
export function Scroll(props) {
  ...
  if (
    containerProps.__fromCodeComponentNode &&
    !constraintsEnabled(unwrappedProps)
  ) {
  ...
  const [contentSize, resizedChildren] = useScrollConstraints(
    containerSize,
    direction,
    children
  );
  ...
  if (contentWidth !== undefined) {
    actualContentSize = Object.assign(Object.assign({}, actualContentSize), {
      width: contentWidth,
    });
  }
  ...
  return React.createElement(
    ...
    Object.assign({}, containerProps, {
      overflow: overflow,
      style: Object.assign({ background: "transparent" }, style),
    ...
    React.createElement(
      FrameWithMotion,
      {
        ...
        onUpdate: updateScrollListeners,
        onDirectionLock: onDirectionLock,
        width: actualContentSize.width,
      ...
      React.createElement(
        "div",
        { ref: dragRef, style: { display: "contain" } },
