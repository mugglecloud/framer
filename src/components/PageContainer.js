...
export function PageContainer({ children, effect, dragEnabled, direction, contentHeight, contentWidth, alignment, gap, isLastPage, contentOffset, scrollControls, maxScrollOffset, directionLock, onDragStart, onDrag, onDragEnd, }) {
    ...
    return (React.createElement(FrameWithMotion, { position: "relative", "data-framer-component-type": "PageContainer", width: containerWidth, height: containerHeight, background: "transparent", drag: dragEnabled ? dragAxis : false, dragDirectionLock: directionLock, _dragValueX: contentOffset.x, _dragValueY: contentOffset.y, _dragTransitionControls: scrollControls, dragConstraints: { top: -maxScrollOffset, left: -maxScrollOffset, right: 0, bottom: 0 }, onDrag: onDrag, onDragStart: onDragStart, onDragEnd: onDragEnd, preserve3d: true, style: {
        ...
        React.createElement(FrameWithMotion, { position: "relative", "data-framer-component-type": "PageContentWrapper", width: wrapperWidth, height: wrapperHeight, preserve3d: false, key: effect ? Object.keys(effect).join("") : "", background: "transparent", style: {
                ...effect,
                display: "flex",
