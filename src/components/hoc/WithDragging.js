...
import { Rect, isFiniteNumber } from "../../render";
...
export function WithDragging(Component) {
  var _a;
  const withDragging =
    ((_a = class WithDraggingHOC extends React.Component {
      ...
      setupAnimationForAxis(axis) {
        ...
        animation = new MainLoopAnimationDriver(
          animator,
          updateCallback,
          doneCallback
        );
