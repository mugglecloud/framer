...
export class DeviceRenderer extends React.Component {
    ...
    renderCanvasMode() {
        ...
        if (responsive) {
            ...
            return (React.createElement(Screen, { width: device.width, height: device.height, scale: 1 },
                React.createElement(ProvideParentSize, { parentSize: content }, this.props.children)));
        } // else
        this.contentScale = 1;
        ...
        return (React.createElement("div", { style: screenStyle },
            React.createElement(Screen, { width: device.width, height: device.height, scale: this.contentScale },
                React.createElement(MotionPlugins, { transformPagePoint: this.transformDevicePoint },
                    React.createElement(ProvideParentSize, { parentSize: content }, this.props.children)))));
    }
    renderScreenOnly() {
        ...
        this.setScreenPosition(screenStyle);
        return (React.createElement("div", { style: screenStyle },
            React.createElement(Screen, { width: screenWidth / pixelRatio, height: screenHeight / pixelRatio, scale: this.contentScale },
                React.createElement(MotionPlugins, { transformPagePoint: this.transformDevicePoint }, this.props.children))));
    }
    renderSkinAndScreen(skin, hand) {
        ...
        const screenElement = (React.createElement("div", { key: "screen", style: screenStyle },
            React.createElement(Screen, { width: screen.width / pixelRatio, height: screen.height / pixelRatio, scale: this.contentScale },
                React.createElement(MotionPlugins, { transformPagePoint: this.transformDevicePoint }, this.props.children))));
        // Device
