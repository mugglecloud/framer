...
export const Stack = React.memo(function Stack({ direction = "vertical", distribution = "start", alignment = "center", gap = 10, children, style: styleProp, willChangeTransform, __fromCodeComponentNode, ...containerProps }) {
    ...
    return (React.createElement(FrameWithMotion, Object.assign({ background: background }, containerProps, { "data-framer-component-type": "Stack", "data-framer-stack-direction-reverse": isReverse, style: style }), content));
});
/**
