...
export class Screen extends React.Component {
    ...
    render() {
        ...
        const frame = (React.createElement(FrameWithMotion, { ref: this.elementRef, width: width, height: height, style: { originX: 0, originY: 0, scale, backgroundColor: color } }, children));
        return React.createElement(FramerEventListener, { session: this.session }, frame);
    }
